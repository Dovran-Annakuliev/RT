...
//	data->window = SDL_CreateWindow("RTv1",SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1000, 1000, SDL_WINDOW_SHOWN);
	...
	data->o[0] = new_cone((cl_float3){0.0f, 0.0f, -10.0f}, 30.0f, (cl_float3){0.0f, 1.0f, 0.0f}, new_material((cl_float4){255, 255, 255, 0}, 100, 0.3f));
	data->o[1] = new_cone((cl_float3){0.0f, 0.0f, -10.0f}, 30.0f, (cl_float3){1.0f, 0.0f, 0.0f}, new_material((cl_float4){255, 255, 255, 0}, 100, 0.3f));
	data->o[2] = new_sphere((cl_float3){0.0f, 0.0f, -10.0f}, 0.5f, new_material((cl_float4){255, 0, 0, 0}, 50, 0.3f));
	...
	data->lights[1] = new_point_light((cl_float3){5.0f, 5.0f, 5.0f}, 0.3f);
