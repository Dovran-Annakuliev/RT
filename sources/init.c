...
//	data->window = SDL_CreateWindow("RTv1",SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1000, 1000, SDL_WINDOW_SHOWN);
	...
	data->o[0] = new_sphere((cl_float3){0.0f, 0.0f, -10.0f}, 0.5f, new_material((cl_float4){255, 0, 0, 0}, 0, 0.3f));
	data->o[1] = new_sphere((cl_float3){-2.0f, 0.0f, -10.0f}, 0.5f, new_material((cl_float4){255, 255, 0, 0}, 50, 0.3f));
	data->o[2] = new_sphere((cl_float3){2.0f, 0.0f, -10.0f}, 0.5f, new_material((cl_float4){0, 0, 255, 0}, 500, 0.0f));
	data->o[3] = new_sphere((cl_float3){0.0f, 11.0f, -13.0f}, 10.0f, new_material((cl_float4){0, 255, 255, 0}, 5000, 0.0f));
