...
//	data->window = SDL_CreateWindow("RTv1",SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1000, 1000, SDL_WINDOW_SHOWN);
	...
	data->o[0] = new_sphere((cl_float3){0.0f, 0.0f, -10.0f}, 0.5f, new_material((cl_float4){0, 255, 0, 0}, 0.3f, 0.7f));
	data->o[1] = new_sphere((cl_float3){-2.0f, 0.0f, -10.0f}, 0.5f, new_material((cl_float4){255, 0, 0, 0}, 0.4f, 0.7f));
	data->o[2] = new_sphere((cl_float3){2.0f, 0.0f, -10.0f}, 0.5f, new_material((cl_float4){0, 0, 255, 0}, 0.6f, 0.7f));
	data->o[3] = new_sphere((cl_float3){0.0f, 11.0f, -13.0f}, 10.0f, new_material((cl_float4){0, 255, 255, 0}, 0.3f, 0.7f));
	data->lights[0] = new_ambient_light(0.3f);
	data->lights[1] = new_point_light((cl_float3){10.0f, -10.0f, 1.0f}, 0.3f);
